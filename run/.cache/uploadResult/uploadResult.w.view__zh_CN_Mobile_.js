...
var __result = __parent1._extend(__parent0).extend({
 ...
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","label":"id","name":"id","relation":"id","rules":{"integer":true},"type":"Integer"},"name":{"define":"name","label":"名称","name":"name","relation":"name","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","initData":"[{\"id\":1,\"name\":\"跑步\"},{\"id\":2,\"name\":\"游泳\"},{\"id\":3,\"name\":\"爬山\"},{\"id\":4,\"name\":\"骑车\"},{\"id\":5,\"name\":\"走路\"}]","limit":20,"xid":"wayData"});
