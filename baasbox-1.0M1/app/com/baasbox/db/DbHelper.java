...
public class DbHelper {
	...
	public static void updateDefaultUsers() throws Exception {
		...
		user = db.getMetadata().getSecurity()
				.getUser(BBConfiguration.getBaasBoxAdminUsername());
	...
	static void createDefaultCollections() throws Throwable {
		if (Logger.isTraceEnabled())
			Logger.trace("Method Start");
		CollectionService.create("Action");
		CollectionService.create("Team");
		CollectionService.create("RunData");
		if (Logger.isTraceEnabled())
			Logger.trace("Method End");
	}
