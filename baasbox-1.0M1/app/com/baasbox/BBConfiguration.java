...
public class BBConfiguration implements IBBConfigurationKeys {
	...
	public static String getWechatAppid() {
		return configuration.getString(WECHAT_APPID);
	}
	
	public static String getWechatAppsecret() {
		return configuration.getString(WECHAT_APPSECRET);
	}
	
	public static String getWechatOpenidPassword() {
		return configuration.getString(WECHAT_OPENID_PASSWORD);
	}
