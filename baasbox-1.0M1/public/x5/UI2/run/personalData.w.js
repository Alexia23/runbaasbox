...
var __parent0=require('$model/UI2/run/personalData'); 
require('css!$model/UI2/run/personalData').load();
var __result = __parent1._extend(__parent0).extend({
	constructor:function(contextUrl){
	this.__sysParam='true';
	this.__contextUrl=contextUrl;
	this.__id='__baseID__';
	this._flag_='da263d32d345c0b19ba3f145773947de';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":false,"defCols":{"distance":{"define":"distance","label":"等效跑步距离km","name":"distance","relation":"distance","rules":{"number":true},"type":"Float"},"id":{"define":"id","label":"#","name":"id","relation":"id","rules":{"integer":true},"type":"Integer"},"uploadtime":{"define":"uploadtime","label":"上传时间","name":"uploadtime","relation":"uploadtime","rules":{"datetime":true},"type":"DateTime"}},"directDelete":true,"events":{"onCustomRefresh":"mainDataCustomRefresh"},"idColumn":"id","initData":"[]","limit":10,"xid":"personalData"});
}}); 
return __result;});
