define(function(require){
	...
	if(Browser.isAndroid){
	    ...
	    $('<style type="text/css">.android_soft_input_cover_bug{position:fixed !important;width:100% !important;left:0 !important;bottom:0 !important;margin:0 !important;}</style>').appendTo('body');
